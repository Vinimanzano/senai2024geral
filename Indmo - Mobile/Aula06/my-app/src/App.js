...
function ProductCard({ name, title, addToCart, descricao }) {
  return (
    <div className="col-md-4">
      <Card>
        <Card.Img variant="top" src={`/${name.toLowerCase()}.png`} />
        <Card.Body>
  ...
  return (
    <div>
      ...
      <Container className="mt-5">
        ...
        <div className="row">
          <ProductCard name="Relogio" title="Watch Shopee" addToCart={addToCart} descricao={"Um Relogio de boa qualidade"} />
          <ProductCard name="Apple Watch" title="Apple Watch" addToCart={addToCart} descricao={"Venha fazer parte da melhor marca do mundo"} />
          <ProductCard name="Rolex" title="Rolex" addToCart={addToCart} descricao={"Qualidade é aqui"} />
          <ProductCard name="Smart" title="Smart Ultra 9" addToCart={addToCart} descricao={"Compre seu Smart ultra 9"} />
          <ProductCard name="milles" title="Richard Milles" addToCart={addToCart} descricao={"Faça parte das pessoas mais bem sucedidas do mundo"} />
          <ProductCard name="linwear" title="Lin Wear" addToCart={addToCart} descricao={"Faça pagamentos e tudo com maior facilidade com nosso Smart Watch"} />
        </div>
      </Container>
